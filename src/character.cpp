...
void char_data::unequip( obj_data * obj )
{
     ...
     * * Finell   -- Shaddai
     */
    if( obj->wear_loc == WEAR_WIELD && this != saving_char && this != loading_char && this != quitting_char && ( tobj = this->get_eq( WEAR_DUAL_WIELD ) ) != nullptr )
...
bool char_data::to_room( room_index * pRoomIndex )
{
    ...
    if( ( obj = this->get_eq( WEAR_LIGHT ) ) != nullptr && obj->item_type == ITEM_LIGHT && ( obj->value[2] != 0 || IS_SET( obj->value[3], PIPE_LIT ) ) )
        ++pRoomIndex->light;
