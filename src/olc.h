...
enum mob_flags
{
    ...
    ACT_AGGRESSIVE, ACT_STAY_AREA, ACT_WIMPY, ACT_PET, ACT_NOSTEAL,
...
enum affected_by_types
{
    ...
    AFF_FAERIE_FIRE, AFF_INFRARED, AFF_CURSE, AFF_GRAPPLE, AFF_POISON,
...
enum item_types
{
    ...
    ITEM_SCABBARD, ITEM_PUDDLE, ITEM_TREASURE, ITEM_ARMOR, ITEM_POTION,
    ITEM_CLOTHING, ITEM_FURNITURE, ITEM_TRASH, ITEM_JOURNAL, ITEM_CONTAINER,
 ...
 */
/* Don't forget to add the flag to o_flags in build.cpp!!! */
enum item_extra_flags
{
    ...
    ITEM_SINDHAE, ITEM_MUSTMOUNT, ITEM_NOAUCTION, ITEM_THROWN, ITEM_PERMANENT,
    ITEM_DEATHDROP, ITEM_NOFILL, MAX_ITEM_FLAG
};
...
enum apply_types
{
    ...
    APPLY_DRUNK, APPLY_HIT_REGEN, // 64
    APPLY_MANA_REGEN, APPLY_MOVE_REGEN, APPLY_ANTIMAGIC,    // 67
    APPLY_ROOMFLAG, APPLY_SECTORTYPE, APPLY_ROOMLIGHT, APPLY_TELEVNUM,     // 71
    APPLY_TELEDELAY, APPLY_COOK, APPLY_RECURRINGSPELL, APPLY_RACE, APPLY_HITNDAM,    // 76
    APPLY_SAVING_ALL, APPLY_EAT_SPELL, APPLY_RACE_SLAYER, APPLY_ALIGN_SLAYER,   // 80
    APPLY_CONTAGIOUS, APPLY_EXT_AFFECT, APPLY_ODOR, APPLY_PEEK, APPLY_ABSORB,   // 85
    APPLY_ATTACKS, APPLY_EXTRAGOLD, APPLY_ALLSTATS, MAX_APPLY_TYPE    // 89 ( counting MAX_APPLY_TYPE )
};
...
enum room_flags
{
    ...
    ROOM_ISOLATED, ROOM_WATCHTOWER, ROOM_NOQUIT, ROOM_TELENOFLY, ROOM_TRACK,
    ROOM_NOYELL, ROOM_NOWHERE, ROOM_NOTRACK, ROOM_MAX
};
...
enum prog_types
{
    ...
    TELL_AND_PROG, CMD_PROG, EMOTE_PROG, LOGIN_PROG, VOID_PROG, LOAD_PROG,
    GREET_IN_FIGHT_PROG, MAX_PROG
};
