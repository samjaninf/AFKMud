...
void imc_hotboot( void )
{
    ...
    if( this_imcmud && this_imcmud->state == IMC_ONLINE )
    {
        ...
        {
            stream << ( !this_imcmud->network.empty(  )? this_imcmud->network : "Unknown" ) << " " << ( !this_imcmud->servername.empty(  )? this_imcmud->
                                                                                                        servername : "Unknown" ) << endl;
            stream.close(  );
            imc_savehistory(  );
        }
    }
...
void web_imc_list(  )
{
    ...
    {
        stream << "<tr><td><font color=\"#008080\">" << this_imcmud->localname << "</font></td><td><font color=\"blue\">" << this_imcmud->versionid <<
            "</font></td><td><font color=\"green\">" << this_imcmud->network << "</font></td><td><font color=\"#00FF00\">" << this_imcmud->
            servername << "</font></td></tr>" << endl;
    }
    else
    {
        ...
        stream << "<tr><td><font color=\"#008080\"><a href=\"" << urldump << "\" class=\"dcyan\" target=\"_blank\">" <<
            this_imcmud->
            localname << "</a></font></td><td><font color=\"blue\">" << this_imcmud->versionid << "</font></td><td><font color=\"green\">" << this_imcmud->network <<
            "</font></td><td><font color=\"#00FF00\">" << this_imcmud->servername << "</font></td></tr>" << endl;
    }
    ...
    for( irin = imc_reminfolist.begin(  ); irin != imc_reminfolist.end(  ); ++irin, ++count )
    {
        ...
        {
            stream << "<tr><td><font color=\"" << font << "\">" << rin->rname << "</font></td><td><font color=\"blue\">" << rin->version <<
                "</font></td><td><font color=\"green\">" << netname << "</font></td><td><font color=\"#00FF00\">" << serverpath << "</font></td></tr>" << endl;
        }
        else
        {
            mudstrlcpy( urldump, rin->url.c_str(  ), MIL );
            stream << "<tr><td><font color=\"" << font << "\"><a href=\"" << urldump << "\" class=\"" << ( rin->expired ? "red" :
                                                                                                           "dcyan" ) <<
                "\" target=\"_blank\">" << rin->
                rname << "</a></font></td><td><font color=\"blue\">" << rin->version << "</font></td><td><font color=\"green\">" << netname <<
                "</font></td><td><font color=\"#00FF00\">" << serverpath << "</font></td></tr>" << endl;
        }
    }
